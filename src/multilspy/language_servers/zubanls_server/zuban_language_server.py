...
class ZubanLanguageServer(LanguageServer):
    def __init__(self, config: MultilspyConfig, logger: MultilspyLogger, repository_root_path: str):
        ...
        super().__init__(
            ...
            ProcessLaunchInfo(cmd="zuban server", cwd=repository_root_path),
            "python",
        )
    ...
    @asynccontextmanager
    async def start_server(self) -> AsyncIterator["ZubanLanguageServer"]:
        """
